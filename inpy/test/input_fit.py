...
# fname_tr contains the transit data (it can be a list of data files)
...
# Define the stellar parameters to calculate the planet parameters
mstar_mean  = 1.0
mstar_sigma = 0.1
rstar_mean  = 1.0
rstar_sigma = 0.1
...
fit_v0 = 'u'     # We fit systemic velocities with uniform priors
